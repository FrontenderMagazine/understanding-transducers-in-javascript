...
Последняя визуализация показывает, что мы хотим получить композицию функций map, filter и reduce и передавать данные последовательно каждой из них. Вместо привычного:
